...
const fresherSnap = { ...snap, items: { '0000': { updated_at: 1000 + STALE_S } } };
const d = pickProgress(fresherSnap, { ...live, pushed_at: 1010 }, 1000 + STALE_S + 30);
ok(!d.live.used && d.live.age_s === 30 && d.live.stale === false, '실시간 올리기만 끊기고 스냅샷은 새로우면 멈춤이 아니다(신호 나이 = 더 새 쪽)');
